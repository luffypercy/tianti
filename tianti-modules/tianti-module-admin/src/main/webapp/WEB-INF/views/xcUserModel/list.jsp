...
<body <%@ include file="../common/skin.jsp" %>>
    ...
    <div class="J_content">
		<div class="mt20 plr20">
		  <form action="${ctx }/xcUserModel/list" id="queryForm" method="post">
	        <div class="J_toolsBar clearfix">
				<div class="t_label">账号</div>
				<div class="t_text ml10">
                	<input placeholder="请输入账号" type="text" name="mobile" id="userName" value="${xcUserModelQueryDTO.mobile }"/>
                </div>
...
<script type="text/javascript">
	function myEdit(id){
		...
		$.post('${ctx}/xcUserModel/dialog/edit?id='+id, {}, function(str){
	...
	function updStatus(id, status){
		...
		layer.confirm(content, function(index){
			...
			var loadIdx = layer.load();
			$.ajax({
				url : '${ctx}/xcUserModel/ajax/upd/status',
				type : 'post',
				data : {
					'ids' : ids,
					'status' : status
